...
if (!function_exists('haaski_minimal_css_custom')) {

	function haaski_minimal_css_custom() { 
		...
		if (savana_lite_setting('haaski_minimal_body_font_family'))
			$css .= "body { font-family:".esc_html(haaski_minimal_google_font_name('haaski_minimal_body_font_family'))."; }";
		...
		if ( savana_lite_setting('savana_lite_menu_font_size') )  : 
			$css .= "#header nav.header-menu ul li a { font-size:".esc_html(savana_lite_setting('savana_lite_menu_font_size'))."; }"; 
			$css .= "#header nav.header-menu ul ul li a { font-size:" . ( str_replace("px", "", esc_html(savana_lite_setting('savana_lite_menu_font_size'))) - 2 ) . "px;}"; 
		endif;
		
		if (savana_lite_setting('savana_lite_menu_font_weight'))
			$css .= "#header nav.header-menu ul li a { font-weight:" . esc_html(savana_lite_setting('savana_lite_menu_font_weight')) . ";}"; 
		
		if (savana_lite_setting('savana_lite_menu_text_transform'))
			$css .= "#header nav.header-menu ul li a { text-transform:" . esc_html(savana_lite_setting('savana_lite_menu_text_transform')) . ";}"; 
		...
		wp_add_inline_style( 'haaski-minimal-style', $css );
		
	}

	add_action('wp_enqueue_scripts', 'haaski_minimal_css_custom', 999);
